...
#ifdef ESP8266
#include <functional>
#define MQTT_CALLBACK_SIGNATURE typedef std::function<void(unsigned int period, unsigned long address, unsigned long groupBit, unsigned long unit, unsigned long switchType)> NewRemoteReceiverCallBack;
#else
